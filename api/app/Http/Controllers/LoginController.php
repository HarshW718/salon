...
class LoginController extends Controller
{
    ...
    public function appointmentReminderMail()
    {
        ...
        foreach ($appointments as $appointment) {
            ...
            if ($diff == 0 || $diff >= $days) {
                ...
                $company_logo    =  empty($companyData) ? '' : $imageUrl . '/salon/assets/images/' . $companyData[0]->company_logo;
    ...
    public function testworker()
    {
        ...
        echo date("c", strtotime($start_time));
        die;
...
echo $service["name"];
        ...
        <tbody>
            ...
            echo $appointment_info_calendar = $appointment_details_top_calendar . $appointment_details_calendar . $appointment_details_down_calendar;
            die;
        }
        /*  $appointment_details_top_calendar = '<table style="width:100%;">
        <tbody>
