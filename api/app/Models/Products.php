...
class Products extends Model
{
    ...
    protected $fillable = ['id', 'name', 'hsn_code', 'created_at', 'updated_at', 'category_id', 'company_id', 'tax_id', 'ean', 'sku', 'stocke', 'min_stocke', 'type', 'sale_price', 'purchase_price', 'created_by', 'updated_by', 'user_company_id'];
